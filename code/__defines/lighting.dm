...
#define LIGHTING_FALLOFF 2 // type of falloff to use for lighting; 1 for circular, 2 for square
...
#define LIGHTING_ROUND_VALUE (1 / 69) // Value used to round lumcounts, values smaller than 1/69 don't matter (if they do, thanks sinking points), greater values will make lighting less precise, but in turn increase performance, VERY SLIGHTLY.
