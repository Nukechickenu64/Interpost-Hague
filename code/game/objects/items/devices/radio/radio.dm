...
/obj/item/device/radio/talk_into(mob/living/M as mob, message, channel, var/verb = "speaks into the radio", var/datum/language/speaking = null)
...
/obj/item/device/radio/announcer
	...
	anchored = 1
	simulated = 0
	channels=list("Engineering" = 1, "Security" = 1, "Medical" = 1, "Command" = 1, "Common" = 1, "Science" = 1, "Supply" = 1, "Service" = 1, "Exploration" = 1, "Inquisition" = 1)
