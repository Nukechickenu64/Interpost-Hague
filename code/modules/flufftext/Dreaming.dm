...
var/list/dreams = list(
	...
	"a blue light","an abandoned laboratory","randy sandy", "pirates", "mercenaries","blood","healing","power","respect",
	...
	"a beach","the holodeck","a smokey room","a voice","the cold","a mouse","an operating table","the rain","a scientist",
	"a station","a vessel overseer","the ai core","a beaker of strange liquid","the supermatter", "a creature built completely of stolen flesh",
