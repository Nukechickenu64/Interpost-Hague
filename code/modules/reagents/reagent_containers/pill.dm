...
/obj/item/weapon/reagent_containers/pill/New()
	..()
	if(!icon_state)
		icon_state = "pill[rand(1, 20)]" //preset pills only use colour changing or unique icons

/obj/item/weapon/reagent_containers/pill/examine()
	if(name && desc)
		if(ishuman(usr))
