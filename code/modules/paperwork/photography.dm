...
/obj/item/weapon/photo/proc/show(mob/user as mob)
	...
	var/body = "<div style='text-align:center'><img src='tmp_photo_[id].png' width='[64*photo_size]' style='-ms-interpolation-mode:nearest-neighbor;image-rendering:pixelated' />" \
		+ "[scribble ? "<br>Written on the back:<br><i>[scribble]</i>" : ""]" \
		+ "</div>"
	var/page = ui_build_styled_html(name, body)
	user << browse(page, "window=book;size=[64*photo_size]x[scribble ? 400 : 64*photo_size]")
	onclose(user, "[name]")
	return
