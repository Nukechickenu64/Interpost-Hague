...
/material/proc/build_rod_product(var/mob/user, var/obj/item/stack/used_stack, var/obj/item/stack/target_stack)
	...
	if(!user.skillcheck(user.skills["engineering"], 60, "I have botched bulding what I'm building.", "engineering"))
		return
...
/material/proc/build_wired_product(var/mob/user, var/obj/item/stack/used_stack, var/obj/item/stack/target_stack)
	...
	if(!user.skillcheck(user.skills["engineering"], 60, "I have botched adding the wires.", "engineering"))
		return
...
/material/glass/build_windows(var/mob/living/user, var/obj/item/stack/used_stack)
	...
	if(!user.skillcheck(user.skills["engineering"], 60, "I have failed to build a window.", "engineering"))
		return 1
