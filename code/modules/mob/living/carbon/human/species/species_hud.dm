/datum/hud_data
	...
	var/list/gear = list(
		...
		"l_ear" =        list("loc" = ui_l_ear,     "name" = "Left Ear",     "slot" = slot_l_ear,     "state" = "ear-l",   "toggle" = 1),
		"r_ear" =        list("loc" = ui_r_ear,     "name" = "Right Ear",    "slot" = slot_r_ear,     "state" = "ear-r",   "toggle" = 1),
		...
		"amulet" =       list("loc" = ui_amulet,    "name" = "Amulet",       "slot" = slot_wear_amulet, "state" = "amulet"),
