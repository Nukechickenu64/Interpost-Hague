...
/mob/living/simple_animal/destroyerbot  //ported straight from deathnet (yes, I know, although this code is quiet good), someone should probably fix up the issues here
	name = "Auto-Enforcer"
	desc = "Hulking mass of steel and servos, inscribed with the phrase 'Auto-Enforcer' across the chest area. Seemingly impervious to any means of attack."
