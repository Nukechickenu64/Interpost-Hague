...
/datum/map/neoderelict
	name = "Derelict"
	full_name = "Derelict Station"
	path = "neoderelict"
	...
	shuttle_called_message = "A scheduled crew transfer shuttle Elipse has been sent."
	shuttle_recall_message = "The Elipse has been recalled. Continuous wasting of resources may result in the crew's termination."
	emergency_shuttle_docked_message = "The Elipse has docked with the station. Command staff is prioritised."
	emergency_shuttle_leaving_dock = "The Elipse emergency escape shuttle has departed from %dock_name%."
	emergency_shuttle_called_message = "Elipse emergency escape shuttle has been sent. It will arrive in approximately 10 minutes."
	emergency_shuttle_recall_message = "The Elipse emergency escape shuttle has been recalled. Continuous wasting of resources may result in the crew's termination."

	evac_controller_type = /datum/evacuation_controller/shuttle

/datum/map/neoderelict/perform_map_generation()
