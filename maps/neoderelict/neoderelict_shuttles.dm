...
/obj/turbolift_map_holder/neoderelict
	icon = 'icons/obj/turbolift_preview_3x3.dmi'
	depth = 2
	lift_size_x = 4
	lift_size_y = 4

/obj/turbolift_map_holder/neoderelict/freight_elevator
	name = "neoderelict turbolift map placeholder"
	areas_to_use = list(
...
/obj/turbolift_map_holder/neoderelict/cargo
